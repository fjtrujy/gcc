...
(define_predicate "vu0_acc_operand"
  (and (match_code "reg")
       (match_test "VU0_ACC_REG_P (REGNO (op))")))

(define_predicate "fpu_acc_operand"
  (and (match_code "reg")
       (match_test "FPU_ACC_REG_P (REGNO (op))")))

;; R5900 Pipeline 1 HI1/LO1 register predicates.
(define_predicate "lo1_operand"
  (and (match_code "reg")
       (match_test "REGNO (op) == LO1_REGNUM")))

(define_predicate "hilo1_operand"
  (and (match_code "reg")
