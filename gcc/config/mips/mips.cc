...
const enum reg_class mips_regno_to_class[FIRST_PSEUDO_REGISTER] = {
  ...
  VU0_Q_REG,	VU0_I_REG	/* VU0 Q and I registers */
};
...
mips_class_max_nregs (enum reg_class rclass, machine_mode mode)
{
  ...
  if (hard_reg_set_intersect_p (left, reg_class_contents[(int) VU0_ACC_REG]))
    {
      if (ISA_HAS_VU0 && mode == E_V4SFmode)
	size = MIN (size, 16);

      left &= ~reg_class_contents[VU0_ACC_REG];
    }
  /* FPU (COP1) accumulator is 32-bit wide (SF mode).  */
  if (hard_reg_set_intersect_p (left, reg_class_contents[(int) FPU_ACC_REG]))
    {
      if (TARGET_MIPS5900 && mode == E_SFmode)
	size = MIN (size, 4);

      left &= ~reg_class_contents[FPU_ACC_REG];
    }
...
#define MIPS_SET_FCSR 1
  ...
  /* Masked operations with arbitrary dest field */
  VU0_BUILTIN_PURE (vadd_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vsub_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmul_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vabs_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vmax_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmini_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmove_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vmadd_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmsub_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmula_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmadda_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmsuba_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vadda_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vsuba_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),

  /* Broadcast masked operations (BC variants) */
  VU0_BUILTIN_PURE (vaddx_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vaddy_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vaddz_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vaddw_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vsubx_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vsuby_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vsubz_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vsubw_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmulx_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmuly_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmulz_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmulw_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmaddx_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmaddy_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmaddz_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmaddw_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmsubx_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmsuby_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmsubz_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  VU0_BUILTIN_PURE (vmsubw_m, MIPS_V4SF_FTYPE_V4SF_V4SF_SI),
  /* Broadcast ACC masked operations */
  VU0_NO_TARGET_BUILTIN (vmulax_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmulay_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmulaz_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmulaw_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmaddax_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmadday_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmaddaz_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmaddaw_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmsubax_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmsubay_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmsubaz_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmsubaw_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vaddax_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vadday_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vaddaz_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vaddaw_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vsubax_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vsubay_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vsubaz_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vsubaw_m, MIPS_VOID_FTYPE_V4SF_V4SF_SI),
  /* Q register masked operations */
  VU0_BUILTIN_PURE (vaddq_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vsubq_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vmulq_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vmaxq_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vminiq_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vmaddq_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vmsubq_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vaddaq_m, MIPS_VOID_FTYPE_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vsubaq_m, MIPS_VOID_FTYPE_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmulaq_m, MIPS_VOID_FTYPE_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmaddaq_m, MIPS_VOID_FTYPE_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmsubaq_m, MIPS_VOID_FTYPE_V4SF_SI),
  /* I register masked operations */
  VU0_BUILTIN_PURE (vaddi_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vsubi_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vmuli_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vmaxi_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vminii_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vmaddi_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vmsubi_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vaddai_m, MIPS_VOID_FTYPE_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vsubai_m, MIPS_VOID_FTYPE_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmulai_m, MIPS_VOID_FTYPE_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmaddai_m, MIPS_VOID_FTYPE_V4SF_SI),
  VU0_NO_TARGET_BUILTIN (vmsubai_m, MIPS_VOID_FTYPE_V4SF_SI),
  /* Conversion masked operations */
  VU0_BUILTIN_PURE (vftoi0_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vftoi4_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vftoi12_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vftoi15_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vitof0_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vitof4_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vitof12_m, MIPS_V4SF_FTYPE_V4SF_SI),
  VU0_BUILTIN_PURE (vitof15_m, MIPS_V4SF_FTYPE_V4SF_SI),
  /* Data movement masked operations */
  VU0_BUILTIN_PURE (vmr32_m, MIPS_V4SF_FTYPE_V4SF_SI),
  ...
  /* Parallel add/subtract halfword: PADSBH */
  MMI_BUILTIN_PURE (padsbh, MIPS_V8HI_FTYPE_V8HI_V8HI),
