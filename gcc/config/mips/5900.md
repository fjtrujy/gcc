...
;; 128-bit vectors of words, halfwords, bytes and TI mode
(define_mode_iterator MMI_VWHB_TI [V4SI V8HI V16QI TI])
...
(define_insn "mov<mode>_internal"
  [(set (match_operand:MMI_VWHB_TI 0 "nonimmediate_operand" "=d,m,d,d,l")
	(match_operand:MMI_VWHB_TI 1 "move_operand"         " d,d,m,l,d"))]
  "TARGET_MIPS5900"
...
(define_insn "ior<mode>3"
  [(set (match_operand:MMI_VWHB_TI 0 "register_operand" "=d")
	(ior:MMI_VWHB_TI (match_operand:MMI_VWHB_TI 1 "register_operand" "d")
		    (match_operand:MMI_VWHB_TI 2 "register_operand" "d")))]
  "TARGET_MIPS5900"
  "por\t%0,%1,%2"
...
(define_insn "xor<mode>3"
  [(set (match_operand:MMI_VWHB_TI 0 "register_operand" "=d")
	(xor:MMI_VWHB_TI (match_operand:MMI_VWHB_TI 1 "register_operand" "d")
		    (match_operand:MMI_VWHB_TI 2 "register_operand" "d")))]
  "TARGET_MIPS5900"
  "pxor\t%0,%1,%2"
...
(define_insn "nor<mode>3"
  [(set (match_operand:MMI_VWHB_TI 0 "register_operand" "=d")
	(and:MMI_VWHB_TI (not:MMI_VWHB_TI (match_operand:MMI_VWHB_TI 1 "register_operand" "d"))
		 (not:MMI_VWHB_TI (match_operand:MMI_VWHB_TI 2 "register_operand" "d"))))]
  "TARGET_MIPS5900"
  "pnor\t%0,%1,%2"
...
(define_insn "one_cmpl<mode>2"
  [(set (match_operand:MMI_VWHB_TI 0 "register_operand" "=d")
	(not:MMI_VWHB_TI (match_operand:MMI_VWHB_TI 1 "register_operand" "d")))]
  "TARGET_MIPS5900"
  "pnor\t%0,%.,%1"
  [(set_attr "type" "simd_logic")
   (set_attr "mode" "<MODE>")])
...
(define_insn "and<mode>3"
  [(set (match_operand:MMI_VWHB_TI 0 "register_operand" "=d")
	(and:MMI_VWHB_TI (match_operand:MMI_VWHB_TI 1 "register_operand" "d")
		    (match_operand:MMI_VWHB_TI 2 "register_operand" "d")))]
  "TARGET_MIPS5900"
  "pand\t%0,%1,%2"
  [(set_attr "type" "simd_logic")
