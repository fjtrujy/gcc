  ...
  "TARGET_MIPS5900"
{
  ...
  emit_insn (gen_pextl<mode>3 (operands[0], gen_rtx_REG (mode, GP_REG_FIRST), operands[1]));
  DONE;
})
...
{
  machine_mode mode = GET_MODE (operands[1]);
  emit_insn (gen_pextu<mode>3 (operands[0], gen_rtx_REG (mode, GP_REG_FIRST), operands[1]));
  DONE;
})
  ...
  "TARGET_MIPS5900"
{
  ...
  emit_insn (gen_pextl<mode>3 (operands[0], sign_extend, operands[1]));
})
  ...
  "TARGET_MIPS5900"
{
  ...
  sign_extend = gen_reg_rtx(mode);
  emit_insn (gen_pcgt<mode> (sign_extend, gen_rtx_REG (mode, GP_REG_FIRST), operands[1]));
  emit_insn (gen_pextu<mode>3 (operands[0], sign_extend, operands[1]));
})
